...
//控制码：开合闸、报警、保电
#define TRIP_OPEN         0
#define TRIP_CLOSE_ALLOW  1
#define TRIP_CLOSE        2
#define TRIP_ALARM        3
#define TRIP_ALARM_REVOKE 4
#define TRIP_KEEP         5
#define TRIP_KEEP_REVOKE  6
...
#define READ_TRIP        9    /*开合闸状态*/

#define ELECT_DATA_FRAME_TYPE_MAX  10          /*最大数据类型*/
...
typedef struct elect_s1
{
	...
	char *Timestamp;
	long rtc;
	int trip;                                      /*开合闸状态*  1：继电器断，开闸状态 0：继电器通，合闸状态*/ 
